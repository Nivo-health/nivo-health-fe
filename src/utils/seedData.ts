  ...
  try {
    ...
    const dummyVisits = [
      // Patient 1 - Ramesh Patil (4 visits - good history)
      {
        ...
        notes:
          'Initial consultation. Patient complains of persistent headache and fatigue. Blood pressure normal.',
        prescription: {
          medicines: [
            {
              id: 'med_1',
      ...
      },
      {
        ...
        status: 'completed' as const,
        notes:
          'Follow-up visit. Headache improved significantly. Patient feels better. Continue medication.',
        prescription: {
          medicines: [
            {
              id: 'med_3',
      ...
      },
      {
        ...
        status: 'completed' as const,
        notes:
          'Routine checkup. Patient reports no headaches. General health good.',
        prescription: {
          medicines: [
            {
              id: 'med_4',
      ...
      // Patient 2 - Priya Sharma (3 visits)
      {
        ...
        status: 'completed' as const,
        notes:
          'First visit. Patient reports mild cough and cold symptoms. No fever.',
        prescription: {
          medicines: [
            {
              id: 'med_5',
      ...
      },
      {
        ...
        status: 'completed' as const,
        notes:
          'Follow-up. Cough resolved. Patient feeling better. No further medication needed.',
        prescription: null,
        followUp: null,
      },
      {
        ...
        status: 'completed' as const,
        notes:
          'Routine checkup. Patient reports seasonal allergies. Prescribed antihistamine.',
        prescription: {
          medicines: [
            {
              id: 'med_7',
      ...
      // Patient 3 - Amit Kumar (2 visits)
      {
        ...
        status: 'completed' as const,
        notes:
          'New patient. Complains of back pain after gym workout. Advised rest and pain relief.',
        prescription: {
          medicines: [
            {
              id: 'med_8',
      ...
      // Patient 4 - Sunita Devi (3 visits)
      {
        ...
        status: 'completed' as const,
        notes:
          'Diabetes checkup. Blood sugar levels stable. Continue current medication.',
        prescription: {
          medicines: [
            {
              id: 'med_10',
      ...
      },
      {
        ...
        status: 'completed' as const,
        notes:
          'Follow-up visit. Blood sugar well controlled. Continue medication as prescribed.',
        prescription: {
          medicines: [
            {
              id: 'med_12',
      ...
      // Patient 5 - Rajesh Singh (2 visits)
      {
        ...
        status: 'completed' as const,
        notes:
          'New patient. Complains of stomach pain and indigestion. Prescribed antacid.',
        prescription: {
          medicines: [
            {
              id: 'med_13',
    ...
    console.log('Dummy data seeding completed:', {
      patients: shouldSeedPatients
        ? dummyPatients.length
        : 'skipped (already exists)',
      visits: shouldSeedVisits
        ? dummyVisits.length
        : 'skipped (already exists)',
    });
  } catch (error) {
